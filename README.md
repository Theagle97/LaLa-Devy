...
### Tikkie ###
- The dues will be paid through Tikkie

### Entry Fee ###
- The Entry Fee for the league is 10 EU per season. With two seasons required upfront. 
- Players must have already paid the two season payment before being permitted to draft.

### Yearly Dues ###
- After the first year there is a yearly total of 10 EU.
...
- The start up will be divided within 2 drafts, the main startup and the start up devy draft. During the main startup you can acquire picks for the startup devy draft.
...
- During the main startup you can pick the next up pick for the devy draft you select any DL.
